...
module InvalidName___Class_0x00___SkipPathHelperForIRB_47
...
class InvalidName___Class_0x00___Vec_48
  def cross(other); end
  def dot(other); end
...
class InvalidName___Class_0x00___Canvas_49
  def draw; end
  def initialize(arg0); end
  def line(arg0, arg1); end
  def line0(p1, p2); end
end
class InvalidName___Class_0x00___RubyModel_50
