...
module Rails::Dom::Testing::Assertions::DomAssertions
  ...
  def refute_dom_equal(expected, actual, message = nil, strict: nil, html_version: nil); end
end
...
class Rails::Dom::Testing::Assertions::SelectorAssertions::HTMLSelector
  ...
  def initialize(values, previous_selection = nil, refute: nil, &root_fallback); end
  def message; end
  def select; end
