...
class RBS::EnvironmentLoader::Library < Anonymous_Struct_51
end
...
class RBS::DefinitionBuilder::MethodBuilder::Methods::Definition < Anonymous_Struct_52
end
...
class RBS::Prototype::RB::Context < Anonymous_Struct_53
end
